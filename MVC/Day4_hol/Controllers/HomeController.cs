...
namespace Day4_hol.Controllers
{
    public class HomeController : Controller
    {
...

        {
            ...
            //    ModelState.AddModelError("AccountNumber", "Accountnumber cannot be negative");
            ...
            //    ModelState.AddModelError("CurrentBalance", "Minimumbalance must be atleast 500");
